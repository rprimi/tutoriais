...
bfi5 <- bfi %>% select(item_text_pt) %>% 
  textEmbed(model = "neuralmind/bert-base-portuguese-cased") 

bfi5 <- bfi %>% select(words) %>% textEmbed(model = "neuralmind/bert-base-portuguese-cased") 


 bfi <-  bfi %>% bind_cols(bfi5$item_text_pt) 
